            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="container-fluid ">
                  ...
                  <MenuUI head="Application" detail={{ "Sentiment Analysis": "/sentiment-analyser", "Text classifier": "/text-classifier", "Keyword Expansion": "/keyword-expansion" }} />
                </div>
              </div>
              <div class="container-fluid col-lg-9 col-md-9 col-sm-12">
                ...
                <Route exact path="/text-classifier" component={TextClassifyUI} />
